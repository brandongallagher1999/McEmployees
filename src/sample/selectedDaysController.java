...
public class selectedDaysController {
    ...
    @FXML Button dS1; // Dishwasher Shift 1
    @FXML Button dS2; // Dishwasher Shift 2
    @FXML Button dS3; // Dishwasher Shift 3
    @FXML Button dS4; // Dishwasher Shift 4
    @FXML Button dS5; // Dishwasher Shift 5
    @FXML Button dS6; // Dishwasher Shift 6
    @FXML Button dS7; // Dishwasher Shift 7
    @FXML Button dS8; // Dishwasher Shift 8
    @FXML Button dS9; // Dishwasher Shift 9
    @FXML Button dS10; // Dishwasher Shift 10
    @FXML Label maxDish; // Max Dishwasher

    @FXML Label currMan; // Current Managers
    @FXML Button mS1; // Manger Shift 1
    @FXML Button mS2; // Manger Shift 2
    @FXML Button mS3; // Manger Shift 3
    @FXML Button mS4; // Manger Shift 4
    @FXML Button mS5; // Manger Shift 5
    @FXML Button mS6; // Manger Shift 6
    @FXML Button mS7; // Manger Shift 7
    @FXML Button mS8; // Manger Shift 8
    @FXML Button mS9; // Manger Shift 9
    @FXML Button mS10; // Manager Shift 10
    @FXML Label maxMan; // Max Managers

    @FXML Label currCook; // Current line Cooks
    @FXML Button cS1; // Line Cook Shift 1
    @FXML Button cS2; // Line Cook Shift 2
    @FXML Button cS3; // Line Cook Shift 3
    @FXML Button cS4; // Line Cook Shift 4
    @FXML Button cS5; // Line Cook Shift 5
    @FXML Button cS6; // Line Cook Shift 6
    @FXML Button cS7; // Line Cook Shift 7
    @FXML Button cS8; // Line Cook Shift 8
    @FXML Button cS9; // Line Cook Shift 9
    @FXML Button cS10; // Line Cook Shift 10
    @FXML Label maxCook; // Max Line Cooks

    @FXML Label currWait; // Current Wait Staff
    @FXML Button wS1; // Wait Staff Shift 1
    @FXML Button wS2; // Wait Staff Shift 2
    @FXML Button wS3; // Wait Staff Shift 3
    @FXML Button wS4; // Wait Staff Shift 4
    @FXML Button wS5; // Wait Staff Shift 5
    @FXML Button wS6; // Wait Staff Shift 6
    @FXML Button wS7; // Wait Staff Shift 7
    @FXML Button wS8; // Wait Staff Shift 8
    @FXML Button wS9; // Wait Staff Shift 9
    @FXML Button wS10; // Wait Staff Shift 10
    @FXML Label maxWait; // Max Wait Staff

    @FXML Label currJanitor; // current Janitors
    @FXML Button jS1; // Janitor Shift 1
    @FXML Button jS2; // Janitor Shift 2
    @FXML Button jS3; // Janitor Shift 3
    @FXML Button jS4; // Janitor Shift 4
    @FXML Button jS5; // Janitor Shift 5
    @FXML Button jS6; // Janitor Shift 6
    @FXML Button jS7; // Janitor Shift 7
    @FXML Button jS8; // Janitor Shift 8
    @FXML Button jS9; // Janitor Shift 9
    @FXML Button jS10; // Janitor Shift 10
